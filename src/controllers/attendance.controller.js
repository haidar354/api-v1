...
export class AttendanceController {
  ...
  static async getAttendanceByClass(c) {
    try {
      ...
      return errorResponse(
        error.message || "Failed to fetch attendance records by class",
        500
      );
    }
  }
  ...
  static async getAttendanceByStudents(c) {
    try {
      ...
      // Get attendance records by students
      const result = await attendanceService.getAttendanceByStudents(
        query_params
      );
      ...
      return errorResponse(
        error.message || "Failed to fetch attendance records by students",
        500
      );
    }
  }
   ...
   * @param {Object} c - Hono context object
   * @returns {Promise<Response>} JSON response with attendance statistics by users
   */
  static async getAttendanceUserStats(c) {
    try {
      // Get validated query parameters from middleware
      const query_params = c.req.valid("query");

      // Get attendance statistics by users
      const result = await attendanceService.getAttendanceUserStats(
        query_params
      );
  ...
  static async restoreAttendance(c) {
    try {
      ...
      return errorResponse(
        error.message || "Failed to restore attendance record",
        500
      );
    }
  }
  ...
  static async createBulkAttendance(c) {
    try {
      ...
      const result = await attendanceService.createBulkAttendance(
        attendances_data
      );
  ...
  static async createGuest(c) {
    try {
      ...
      const result = await attendanceService.createGuest(
        guestData,
        signatureFile
      );
      ...
      return errorResponse(
        error.message || "Failed to create guest record",
        500
      );
    }
  }
  ...
  static async getGuestById(c) {
    try {
      ...
      return errorResponse(
        error.message || "Failed to fetch guest record",
        500
      );
    }
  }
  ...
  static async updateGuest(c) {
    try {
      ...
      const result = await attendanceService.updateGuest(
        id,
        updateData,
        signatureFile
      );
      ...
      return errorResponse(
        error.message || "Failed to update guest record",
        500
      );
    }
  }
  ...
  static async deleteGuest(c) {
    try {
      ...
      return errorResponse(
        error.message || "Failed to delete guest record",
        500
      );
    }
  }
  ...
  static async restoreGuest(c) {
    try {
      ...
      return errorResponse(
        error.message || "Failed to restore guest record",
        500
      );
    }
  }
      ...
      return jsonResponse(
        {
          ...
          info: {
            ...
            validation_rules: {
              full_name:
                "Min 2 chars, max 255 chars, letters/spaces/dots/apostrophes/hyphens only",
