...
/**
 * Role Routes
 * Defines all routes for role and role permission CRUD operations
 */
 ...
 */
roleRoute.get('/', authMiddleware, RoleController.getAllRoles);
 ...
 */
roleRoute.get('/management', authMiddleware, RoleController.getAllRolePermissions);
